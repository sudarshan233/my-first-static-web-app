import { c as createCommonjsModule, r as react, p as process } from '../common/index-a3f89177.js';
...
var __DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = Internals;
...
function assertIsMounted(fiber) {
  if (getNearestMountedFiber(fiber) !== fiber) throw Error(formatProdErrorMessage$1(188));
}
...
var isArrayImpl = Array.isArray,
  ReactSharedInternals$1 = react.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
...
function setValueForStyles(node, styles, prevStyles) {
  if (null != styles && "object" !== typeof styles) throw Error(formatProdErrorMessage$1(62));
  node = node.style;
  if (null != prevStyles) {
...
function getListener(inst, registrationName) {
  ...
  if (inst) return null;
  if (stateNode && "function" !== typeof stateNode) throw Error(formatProdErrorMessage$1(231, registrationName, typeof stateNode));
  return stateNode;
}
...
function getRootForUpdatedFiber(sourceFiber) {
  if (50 < nestedUpdateCount) throw nestedUpdateCount = 0, rootWithNestedUpdates = null, Error(formatProdErrorMessage$1(185));
...
function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
  ...
  if ("function" === typeof type) shouldConstruct(type) && (fiberTag = 1);else if ("string" === typeof type) fiberTag = isHostHoistableType(type, pendingProps, contextStackCursor.current) ? 26 : "html" === type || "head" === type || "body" === type ? 27 : 5;else a: switch (type) {
    ...
    default:
      ...
      fiberTag = 29;
      pendingProps = Error(formatProdErrorMessage$1(130, null === type ? "null" : typeof type, ""));
      owner = null;
  }
...
var prevOnStartTransitionFinish = ReactSharedInternals$1.S;
  ...
  switch (thenable.status) {
    ...
    default:
      if ("string" === typeof thenable.status) thenable.then(noop$3, noop$3);else {
        ...
        if (null !== thenableState && 100 < thenableState.shellSuspendCounter) throw Error(formatProdErrorMessage$1(482));
...
function checkIfUseWrappedInAsyncCatch(rejectedReason) {
  if (rejectedReason === SuspenseException || rejectedReason === SuspenseActionException) throw Error(formatProdErrorMessage$1(483));
}
...
function callCallback(callback, context) {
  if ("function" !== typeof callback) throw Error(formatProdErrorMessage$1(191, callback));
...
function updateWorkInProgressHook() {
  ...
  if (null !== nextWorkInProgressHook) workInProgressHook = nextWorkInProgressHook, currentHook = nextCurrentHook;else {
    if (null === nextCurrentHook) {
      if (null === currentlyRenderingFiber.alternate) throw Error(formatProdErrorMessage$1(467));
...
function runActionStateAction(actionQueue, node) {
  ...
  if (node.isTransition) {
    var prevTransition = ReactSharedInternals$1.T,
      currentTransition = {};
    ReactSharedInternals$1.T = currentTransition;
    try {
      var returnValue = action(prevState, payload),
        onStartTransitionFinish = ReactSharedInternals$1.S;
...
function startTransition(fiber, queue, pendingState, finishedState, callback) {
  ...
  try {
    ...
    ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals$1.T = prevTransition;
  }
}
function noop$2() {}
...
function throwOnInvalidObjectType(returnFiber, newChild) {
  if (newChild.$$typeof === REACT_LEGACY_ELEMENT_TYPE) throw Error(formatProdErrorMessage$1(525));
  returnFiber = Object.prototype.toString.call(newChild);
  throw Error(formatProdErrorMessage$1(31, "[object Object]" === returnFiber ? "object with keys {" + Object.keys(newChild).join(", ") + "}" : returnFiber));
}
...
function throwException(root, returnFiber, sourceFiber, value, rootRenderLanes) {
  ...
  if (isHydrating) return returnFiber = suspenseHandlerStackCursor.current, null !== returnFiber ? (0 === (returnFiber.flags & 65536) && (returnFiber.flags |= 256), returnFiber.flags |= 65536, returnFiber.lanes = rootRenderLanes, value !== HydrationMismatchException && (root = Error(formatProdErrorMessage$1(422), {
    cause: value
  }), queueHydrationError(createCapturedValueAtFiber(root, sourceFiber)))) : (value !== HydrationMismatchException && (returnFiber = Error(formatProdErrorMessage$1(423), {
    cause: value
  ...
  var wrapperError = Error(formatProdErrorMessage$1(520), {
    cause: value
  });
...
function markRef(current, workInProgress) {
  ...
  if (null === ref) null !== current && null !== current.ref && (workInProgress.flags |= 4194816);else {
    if ("function" !== typeof ref && "object" !== typeof ref) throw Error(formatProdErrorMessage$1(284));
...
function bailoutOnAlreadyFinishedWork(current, workInProgress, renderLanes) {
  ...
  if (null !== current && workInProgress.child !== current.child) throw Error(formatProdErrorMessage$1(153));
      ...
      a: {
        ...
        if (prevState.isDehydrated) {
          if (prevState = {
            ...
            init = createCapturedValueAtFiber(Error(formatProdErrorMessage$1(424)), workInProgress);
  ...
  switch (workInProgress.tag) {
    ...
    case 27:
      ...
      if (null !== current && null != workInProgress.stateNode) current.memoizedProps !== newProps && markUpdate(workInProgress);else {
        if (!newProps) {
          if (null === workInProgress.stateNode) throw Error(formatProdErrorMessage$1(166));
          bubbleProperties(workInProgress);
          return null;
        }
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode) current.memoizedProps !== newProps && markUpdate(workInProgress);else {
        ...
        current = contextStackCursor.current;
        if (popHydrationState(workInProgress)) prepareToHydrateHostInstance(workInProgress);else {
    ...
    case 6:
      if (current && null != workInProgress.stateNode) current.memoizedProps !== newProps && markUpdate(workInProgress);else {
        if ("string" !== typeof newProps && null === workInProgress.stateNode) throw Error(formatProdErrorMessage$1(166));
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (null !== current && null !== current.dehydrated) {
        if (null === workInProgress.alternate) throw Error(formatProdErrorMessage$1(340));
        resetHydrationState();
      }
...
function commitMutationEffectsOnFiber(finishedWork, root) {
  ...
  switch (finishedWork.tag) {
    ...
    case 6:
      ...
      commitReconciliationEffects(finishedWork);
      if (flags & 4) {
        if (null === finishedWork.stateNode) throw Error(formatProdErrorMessage$1(162));
  ...
  if (null !== finishedWork) {
    ...
    if (0 !== (finishedWork.subtreeFlags & 13878) || recoverableErrors) {
      ...
      try {
        ...
        executionContext = spawnedLane, ReactDOMSharedInternals.p = transitions, ReactSharedInternals$1.T = recoverableErrors;
      }
    }
  ...
  if (1 === pendingEffectsStatus) {
    ...
    if (0 !== (finishedWork.subtreeFlags & 13878) || rootMutationHasEffect) {
      ...
      try {
        ...
        executionContext = prevExecutionContext, ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals$1.T = rootMutationHasEffect;
      }
    }
  ...
  if (2 === pendingEffectsStatus) {
    ...
    if (0 !== (finishedWork.subtreeFlags & 8772) || rootHasLayoutEffect) {
      ...
      try {
        ...
        executionContext = prevExecutionContext, ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals$1.T = rootHasLayoutEffect;
      }
    }
  ...
  if (4 === pendingEffectsStatus || 3 === pendingEffectsStatus) {
    ...
    if (null !== recoverableErrors) {
      ...
      try {
        ...
        ReactSharedInternals$1.T = finishedWork, ReactDOMSharedInternals.p = remainingLanes;
      }
    }
...
function flushPassiveEffects() {
  ...
  var renderPriority = lanesToEventPriority(pendingEffectsLanes),
    prevTransition = ReactSharedInternals$1.T,
  ...
  try {
    ...
    ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals$1.T = prevTransition, releaseRootPooledCache(root, remainingLanes);
  }
}
...
function setProp(domElement, tag, key, value, props, prevValue) {
  switch (key) {
    ...
    case "dangerouslySetInnerHTML":
      if (null != value) {
        if ("object" !== typeof value || !("__html" in value)) throw Error(formatProdErrorMessage$1(61));
        key = value.__html;
        if (null != key) {
    ...
    case "input":
      ...
      for (hasSrc in props) if (props.hasOwnProperty(hasSrc)) {
        ...
        if (null != propValue$188) switch (hasSrc) {
          ...
          case "children":
          case "dangerouslySetInnerHTML":
            if (null != propValue$188) throw Error(formatProdErrorMessage$1(137, tag));
            break;
          default:
  ...
  switch (tag) {
    ...
    case "input":
      ...
      for (var propKey$205 in nextProps) {
        ...
        if (nextProps.hasOwnProperty(propKey$205) && (null != propKey || null != lastProp)) switch (propKey$205) {
          ...
          case "children":
          case "dangerouslySetInnerHTML":
            if (null != propKey) throw Error(formatProdErrorMessage$1(137, tag));
            break;
          default:
    ...
    case "menuitem":
      ...
      for (checked in nextProps) if (propKey$205 = nextProps[checked], propKey = lastProps[checked], nextProps.hasOwnProperty(checked) && propKey$205 !== propKey && (null != propKey$205 || null != propKey)) switch (checked) {
        case "children":
        case "dangerouslySetInnerHTML":
          if (null != propKey$205) throw Error(formatProdErrorMessage$1(137, tag));
          break;
        default:
  ...
  switch (type) {
    ...
    case "link":
      if ("stylesheet" === pendingProps.rel && "string" === typeof pendingProps.href && "string" === typeof pendingProps.precedence) {
        ...
        if (currentProps && null === currentResource) throw Error(formatProdErrorMessage$1(528, ""));
        return resource$245;
      }
      if (currentProps && null !== currentResource) throw Error(formatProdErrorMessage$1(529, ""));
      return null;
    case "script":
...
if ("19.1.0" !== isomorphicReactPackageVersion$jscomp$inline_1785) throw Error(formatProdErrorMessage$1(527, isomorphicReactPackageVersion$jscomp$inline_1785, "19.1.0"));
ReactDOMSharedInternals.findDOMNode = function (componentOrElement) {
  var fiber = componentOrElement._reactInternals;
  if (void 0 === fiber) {
    if ("function" === typeof componentOrElement.render) throw Error(formatProdErrorMessage$1(188));
...
var createRoot = function (container, options) {
...
var hydrateRoot = function (container, initialChildren, options) {
  if (!isValidContainer(container)) throw Error(formatProdErrorMessage$1(299));
  var isStrictMode = !1,
    identifierPrefix = "",
    onUncaughtError = defaultOnUncaughtError,
...
}
{
  ...
  // DevTools can report bad minification during injection.
  checkDCE();
  module.exports = reactDomClient_production;
}
});

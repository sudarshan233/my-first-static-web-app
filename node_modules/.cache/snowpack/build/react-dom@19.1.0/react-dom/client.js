import require$$0 from 'scheduler';
...
var require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(react);
...
var reactDomClient_development = createCommonjsModule(function (module, exports) {
 ...
 (function () {
    ...
    switch (workInProgress.tag) {
      ...
      case 27:
        ...
        if (null !== current && null != workInProgress.stateNode) current.memoizedProps !== newProps && markUpdate(workInProgress);else {
          ...
          popHydrationState(workInProgress) ? prepareToHydrateHostInstance(workInProgress) : (current = resolveSingletonInstance(_type, newProps, renderLanes, current, !0), workInProgress.stateNode = current, markUpdate(workInProgress));
        }
        bubbleProperties(workInProgress);
        return null;
      case 5:
  ...
  function flushPassiveEffects() {
    ...
    var renderPriority = lanesToEventPriority(pendingEffectsLanes),
      priority =  DefaultEventPriority > renderPriority ? DefaultEventPriority : renderPriority;
...
{
  module.exports = reactDomClient_development;
}
});
...
var version$1 = client.version;
export { client as __moduleExports, createRoot, hydrateRoot, version$1 as version };
